    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            for ($i=0; $i<$num_score; $i++) {
                ...
                $P = explode(":",$pack10);
                $dis = $dis + $distanceavg1;
                $tim = $tim + $timeavg1;
                $spdv = $spdv + $speedavg1;
                $aavg = $aavg + $P[0];

                if ($P[0]>$amax) {$amax=$P[0];}
                if ($P[0]<$amin) {$amin=$P[0];}

                echo " data.addRows([ ['$date0',$P[0]] ]); ";
            ...
            var options = {
                ...
                title: 'Acc Score : <?php echo $selectT;?>',
                titleTextStyle: {
                    color: 'red',
                    fontSize: 15
                },
        ...
        $dis = $dis/($num_score-1);
        $tim = $tim/($num_score-1);
        $spdv = $spdv/($num_score-1);
        $aavg = $aavg/($num_score-1);
        ?>
    </script>

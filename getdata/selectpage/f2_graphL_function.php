    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            for ($i=$lo; $i<=$hi ; $i++) {
                ...
                if ($sec_del3!=0) {
                    $accGP = (($delta_speed/$sec_del3) * (1000/3600));
                }
            ...
            var options = {
                title: '<?php echo "$myUser Point $over_index ($lo-$hi)";?>',
                titleTextStyle: {
                    color: 'blue',
                    fontSize: 12
                },
                ...
                hAxis: {
                    title: 'time (@second)',
                    minValue: <?php echo $lo;?>,
                    count: 2,
                    baselineColor: 'red' ,titleTextStyle:{
                        color: 'black' ,
                        fontSize: 12
                    }
                },
...
<body onload="initialize()" onunload="GUnload()">
    <div id="chart_div" style="width: 100%; height: 220px;"> </div>
</body>
</html>

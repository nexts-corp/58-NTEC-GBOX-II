...
&nbsp;</small><small><a style="color: white;" href="f1_speedBehavior.php" target="_blank">Speed</a></small><small>
&nbsp; &nbsp;Accelleration &nbsp;
&nbsp;Zone &nbsp; &nbsp;Turn &nbsp;</small></td>
</tr>
</tbody>
...
<tbody>
<tr>
<td style="height: 13px; width: 127px; background-color: white; vertical-align: top;" colspan="4" rowspan="1"><small><span style="font-weight: bold;"></span></small><small><span style="font-weight: bold;"></span></small><small><span style="font-weight: bold;"> &nbsp;Device</span>
:&nbsp;</small><small><?php require(dirname(__FILE__)."/../../config.php");
...
ID</span> : </small><small>
    ...
    </small><small><?php echo "$busid";?>&nbsp;&nbsp;
<span style="font-weight: bold;">Date</span>
:
&nbsp;<?php $InDate = explode("/",$Date1);
$day1Array = array("$InDate[2]","$InDate[1]","$InDate[0]");
$Date1 = implode("/",$day1Array);
echo "$Date1";?>
&nbsp;&nbsp;<span style="font-weight: bold;">
...
:&nbsp;
            <!--<php title="include (&quot;f2_speed_function.php&quot;); include (&quot;f2_turn_function.php&quot;); echo &quot;$jhk&quot;;" xmlns="http://disruptive-innovations.com/zoo/nvu">--><?php include ("f2_turn_function.php");
echo "$num_rows";
?>
            <!--</php>--></small></small>&nbsp;
<small><small><big><small><span style="font-weight: bold;">Turn&nbsp;
                    <!--<php title="echo &quot;$stp_point_cnt&quot;;" xmlns="http://disruptive-innovations.com/zoo/nvu">-->
                    <?php echo "$total1";?>
                    <!--</php>-->
:</span></small> <small>&nbsp;<span style="font-weight: bold;">High G.
</span></small></big><small>&nbsp;
            <!--<php title="echo &quot;$curve_over&quot;;" xmlns="http://disruptive-innovations.com/zoo/nvu">--><?php echo "$curve_over";?><!--</php>--></small>
...
<td style="vertical-align: middle; height: 10px; font-family: Arial; background-color: rgb(153, 255, 153); text-align: center; width: 159px;"><small><small style="font-family: Arial;">
            ...
            <span style="font-weight: bold;"> Type :&nbsp;<?php $over_i = $over_index - 400;
echo " <font color='blue'> $type_Turn[$over_i] <font color='black'>";
?></span>&nbsp;<span style="font-weight: bold;">&nbsp;</span>
            <!--<php title="echo &quot; &lt;img src='$colorp[$over_index]' width='10' height='10'/&gt;&quot;;"></php></php>-->
        </small></small></td>
...
elseif ($SpeedMax[$over_i]>=104) { echo " <img src='m5.png' width='14' height='14'/> ";}?> </span><span style="font-weight: bold;"></span></small></small></td>
...
&nbsp;:</small></small></span>&nbsp;<small><small><?php echo "$g_overR[$over_i] ($altH2[$over_i])"; 
?></small></small></td>
...
<td style="background-color: rgb(193, 255, 193); width: 156px; text-align: center;"><small><small><span style="font-family: Arial;"><span style="font-weight: bold;"></span></span></small></small><small><small><span style="font-family: Arial;"></span><span style="font-family: Arial; font-weight: bold;">H/d =</span></small> <?php $grade = (($AccSlope[$over_i]/$delDis[$over_i]) *100);
$grade = round($grade,2);
...
$j3 = floor($j3/6);
$j4 = floor($j4/6);
?><?php /*include ("f2_graphL_function_turn.php");*/
...
<td style="text-align: center;"><?php $k = $LC_total; 
$kk = 5-$k; 


for ($i=1; $i<=$kk; $i++) { echo "<img src='u5.png'/><br>"; } for ($i=1; $i<=$k; $i++) { echo "<img src='u6.png'/><br>"; }?></td>
...
/* $kk = 5-$k; for ($i=1; $i<=$kk; $i++) { echo "<img src='u5.png'/><br>"; } for ($i=1; $i<=$k; $i++) { echo "<img src='u6.png'/><br>"; }
*/?></td>
</tr>
<tr>
<td style="text-align: center;"><small><small><small><font face="Arial" size="2"><small><small><small>Left<br>D</small></small></small></font></small></small></small></td>
<td style="text-align: center;"><small><small><small><font face="Arial" size="2"><small><small><small>Left<br>C</small></small></small></font></small></small></small></td>
<td style="text-align: center;"><small><small><small><font face="Arial" size="2"><small><small><small>Left<br>B</small></small></small></font></small></small></small></td>
<td style="text-align: center; background-color: white;"><small><small><small><font face="Arial" size="2"><small><small><small>Left<br>A</small></small></small></font></small></small></small></td>
<td style="text-align: center;"><small><small><small><span style="font-family: Arial;">Curve<br>L</span></small></small></small></td>
</tr>
</tbody>
</table>
</td>
...
/* $kk = 5-$k; for ($i=1; $i<=$kk; $i++) { echo "<img src='u5.png'/><br>"; } for ($i=1; $i<=$k; $i++) { echo "<img src='u6.png'/><br>"; } */?></td>
...
<tr>
<td style="text-align: center;"><small><small><small><span style="font-family: Arial;">Curve<br>R</span></small></small></small></td>
<td style="text-align: center;"><small><small><font face="Arial" size="2"><small><small>Right<br>A</small></small></font></small></small></td>
<td style="text-align: center;"><small><small><font face="Arial" size="2"><small><small>Right<br>B</small></small></font></small></small></td>
<td style="text-align: center;"><small><small><font face="Arial" size="2"><small><small>Right<br>C</small></small></font></small></small></td>
<td style="text-align: center;"><small><small><font face="Arial" size="2"><small><small>Right<br>D</small></small></font></small></small></td>
</tr>
</tbody>
</table>
</td>
...
<tbody>
<tr>
<td style="vertical-align: top; width: 559px;">&nbsp; <?php for ($i=1; $i<=$stp_point_cnt; $i++) {
...
<td align='center'> <font size='2' color='black'> lat1-lon1 </td> </tr> ";
...
<td align='right'> <font size='2' color='black'> $SpeedMax[$i] km/hr</td> 
<td align='center'> <font size='2' color='black'> $type_Turn[$i] </td> 
<td align='center'> <font size='2' color='black'> $delta_tt[$i] </td> 

<td align='center'> <font size='2' color='black'> $sum_ddT[$i] </td> 
<td align='right'> <font size='2' color='black'>  $latBE1[$i]-$lonBE1[$i] </td></tr> ";
$i = $i+1;
$m=$i+400;
...
</tr><tr><td><table style="text-align: left; width: 100%;" border="1" cellpadding="2" cellspacing="2"><tbody><tr><td><?php if ($stp_point_cnt!=0) {

   $speedSum = round(($speedSum/$stp_point_cnt),2); 
   if ($ap!=0) {$accSumP  = round(($accSumP/$ap),4);}
   $accSumN  = round(($accSumN/$an),4); 
   $duraSum = round(($duraSum/$stp_point_cnt),2); 

 }
 $ra=0;  $rb=0;  $rc=0;  $rd=0; 
 $la=0;  $lb=0;  $lc=0;  $ld=0; 
 $cr=0;  $cl=0;  $sca=0;  $scb=0; $ut=0;
  ...
  for ($i=1; $i<=$curve_over; $i++) {
    ...
    elseif  ($Ttype_over[$i]=="Right-D") { $rd = $rd+1; }  

    elseif  ($Ttype_over[$i]=="Left-A") { $la = $la+1; }
    elseif  ($Ttype_over[$i]=="Left-B") { $lb = $lb+1; }
    elseif  ($Ttype_over[$i]=="Left-C") { $lc = $lc+1; }  
    elseif  ($Ttype_over[$i]=="Left-D") { $ld = $ld+1; }  

    elseif  ($Ttype_over[$i]=="Curve-R")  { $cr = $cr+1; }  
    elseif  ($Ttype_over[$i]=="Curve-L")  { $cl = $cl+1; }  

    elseif  ($Ttype_over[$i]=="SCurve-A") { $sca = $sca+1; }  
    elseif  ($Ttype_over[$i]=="SCurve-B") { $scb = $acb+1; }  

    elseif  ($Ttype_over[$i]=="U-Turn")   { $ut = $ut+1; }  
...
$strSQL = "INSERT INTO  `turnselect` (`timestp` ,`index` ,`date` ,     `point1` ,`point2` , `vavg`   ,`ap` ,`an` ,`duration` ,`lat1` ,`lon1` ,`lat2` ,`lon2` ) 

...
<body style="font-family: Arial;">
    ...
    <form style="height: 345px;" action="f0_acc_report.php" method="get">
        ...
        <table style="background-color: white; width: 1010px; height: 64px; text-align: left; margin-left: auto; margin-right: auto;" border="0" cellpadding="2" cellspacing="2">
            <tbody>
                ...
                <tr style="font-family: Arial; font-size: x-small; height: 30px;">
                    <td style="background-color: rgb(204, 255, 255); width: 155px;">
                        <span>
                    ...
                    <td style="text-align: left; background-color: rgb(204, 255, 255); vertical-align: middle; width: 167px;">
                        <span>
                    ...
                    <td style="background-color: rgb(153, 255, 153); text-align: center; width: 174px; color: red;">
                        <span>
                    ...
                    <td style="vertical-align: middle; background-color: rgb(153, 255, 153); text-align: center; width: 146px;">
                        <span>
                    ...
                    <td style="text-align: center; background-color: rgb(153, 255, 153); width: 160px;">
                        <span>
                            <span style="font-weight: bold;">Speed max. : </span>
                            <span>
                                <?php
                ...
                <tr style="font-family: Arial; font-size: x-small; height: 30px;">
                    ...
                    <td style="background-color: rgb(204, 255, 255); width: 167px;">
                        <span>
                    ...
                    <td style="background-color: rgb(193, 255, 193); text-align: center; width: 146px;">
                        <span>
                            <span style="font-weight: bold;">Time : </span>
                            <span>
                                <?php
                    ...
                    <td style="background-color: rgb(193, 255, 193); text-align: center; width: 160px;">
                        <span>
        ...
        <table style="width: 1010px; height: 40px; text-align: left; margin-left: auto; margin-right: auto;" border="0">
            <tbody>
                <tr>
                    <td colspan="1" rowspan="1" style="font-family: Arial; font-size: small; text-align: left; height: 22px; vertical-align: bottom; width: 946px;">&nbsp;
                        <span>
        ...
        <table style="width: 100%; height: 138px; text-align: left; margin-left: auto; margin-right: auto;" border="0" cellpadding="2" cellspacing="2">
            <tbody>
                <tr>
                    <td rowspan="2" style="background-color: rgb(255, 255, 204); height: 144px; width: 80%;">

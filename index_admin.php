...
if($_COOKIE["gbox"]["role"] == ADMINISTRATOR){
    ...
    <head>
        ...
        <script language="javascript">
            document.write(unescape("%3C%73%63%72%69%70%74%20%73%72%63%3D%22%6A%61%76%61%73%63%72%69%70%74%2F%6A%61%76%61%41%64%6D%69%6E%2E%70%68%70%3F%47%42%4F%58%22%3E%3C%2F%73%63%72%69%70%74%3E%0A%09%09%09"));
        </script>
    </head>
    <body>
    <header>
    ...
    <div class="navigator-left scrollbar" id="style-1">
        ...
        <ul class="topnav menu-left-nest" style="margin: 10px;">
            ...
            <li style="text-align: left;">
                <a class="tooltip-tip ajax-load tooltipster-disable" href="#Style">
                    <i class="icon-camera"></i>
                    <span style="display: inline-block; float: none;">Style</span>
                </a>
            </li>
            <li style="text-align: left;">
                <a class="tooltip-tip ajax-load tooltipster-disable" href="#Integrate">
                    <i class="icon-camera"></i>
                    <span style="display: inline-block; float: none;">Integrate</span>
                </a>
            </li>
            <!--<li style="text-align: left;">
        ...
        <ul class="topnav menu-left-nest" style="margin: 10px;">
            ...
            <li style="text-align: left;">
                <a class="tooltip-tip ajax-load tooltipster-disable" href="#Devices">
                    <i class="icon-camera"></i>
                    <span style="display: inline-block; float: none;">Devices</span>
                </a>
            </li>
            <li style="text-align: left;">
